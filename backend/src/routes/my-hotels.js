...
router.post('/',
    ...
    body("pricePerNight", "Valid Price is required").isNumeric(),
    body("starrating", "Valid Star Rating is required").isNumeric(),
    body("facilities", "Valid facilities are required").isArray(),
    body("type", "Valid Hotel Type is required").isString(),
    body("adults", "Valid Adult Count is required").isNumeric(),
    body("children", "Valid Child Count is required").isNumeric(),
    ],
    verify,
    async(req, res)=>{
    try{
