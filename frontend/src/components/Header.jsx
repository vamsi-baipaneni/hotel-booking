    ...
    <div className='bg-blue-800 py-10 max-w-screen '>
      <div className='md:container md:mx-auto flex justify-between'>
        ...
        <span className='flex gap-2'>
          ...
          <Link className = "flex items-center px-4 text-md text-white font-bold hover:cursor-pointer hover:bg-white hover:text-blue-800" to = "/my-hotels">My Hotels</Link>
          <SignOutButton />
          </>
